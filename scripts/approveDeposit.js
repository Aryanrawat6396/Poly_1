...
const ABI = require('../artifacts/contracts/Aryan.sol/Aryan.json');
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("Aryan");
  const nft = await NFT.attach('0x4213fDf5C53274fd8b0AD32CA1B5a5fEb92F08aa');
  ...
  console.log("AryanNFT wallet balance", wallet.address, "is: ", balance.toString());
}
